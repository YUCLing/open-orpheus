...
**Revision:** 44 (2026-09-22) — P3-1 done: `__test__/helpers/context.ts` exports
`createTestContext()`, and the bootstrap spec now boots the real graph through it
instead of re-declaring its own mocks and fakes.
