...
**Revision:** 36 (2026-09-22) — dev mode re-confirmed by the repo owner **after** P2,
which retires the load-timing risk the seven P2 commits carried. No code change;
the two placement decisions from P2-1 remain open.
