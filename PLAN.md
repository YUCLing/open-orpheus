...
**Revision:** 35 (2026-09-22) — **P2 complete.** P2-4 folded `types/` into
`src/shared/types/` and retired `$sharedTypes` entirely (0 declarations, from 4);
P2-3 decided the two contract surfaces stay separate, with a stated rule.
