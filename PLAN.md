...
**Revision:** 43 (2026-09-22) — `platform/` audited after the `ipc/` lesson: `error.ts`
moved to `bootstrap/` as process wiring, the rest confirmed correctly placed, and the
scope of all six `src/main` groups is now written down in both CONTRIBUTING files.
