...
**Revision:** 23 (2026-09-22) — P1-10 continues: `createMainWindow(deps)` takes the
window service and lifecycle instead of importing `setMainWindow`/`currentState`/
`setLifecycleState`. The two on-demand window factories, the audio engines, `audio.ts`
and `main.ts` remain.
