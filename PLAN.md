...
**Revision:** 46 (2026-09-22) — P3-4 begins: `noPropertyAccessFromIndexSignature` is
**enabled** (35 sites). The §4.2 costs were re-measured first and had drifted upward
since they were taken — 130 → 138 — because the code grew through P1 and P2.
...
| `verbatimModuleSyntax`                            | ~~51~~ **52**                          | Cheap, mechanical (`type`-only imports). **[V]**               |
...
| P3-4  | Mid-cost strictness flags (130 errors total)                                                   | P3    | **In progress** | 2026-09-22 | **`noPropertyAccessFromIndexSignature` enabled** (35 sites, all TS4111, applied by driving `tsc`'s own suggestions). The §4.2 costs were re-measured first and had drifted 130 → **138**. **Remaining:** `exactOptionalPropertyTypes` (51) and `verbatimModuleSyntax` (52).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
