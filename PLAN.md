...
**Revision:** 45 (2026-09-22) — P3-2/3/5 settled. **Q3 is answered by experiment:** a
sandboxed preload evaluates `new Function` and `eval` fine, while `node:` builtins stay
blocked — so the preload plugin plane can install code at runtime (Option A).
