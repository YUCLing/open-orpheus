...
**Revision:** 33 (2026-09-22) — **P2-1 done.** `src/main/` is reorganised into
`bootstrap/`, `services/`, `domain/`, `platform/`, `ipc/` (+ `ipc/handlers/`) and
`windows/` (+ `windows/menu/`): 46 → 9 direct entries, no directory over 15.
