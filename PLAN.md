...
**Revision:** 34 (2026-09-22) — P2-2 done: the `foo.ts` + `foo/` rule is now written
into both `CONTRIBUTING.md` and `docs/CONTRIBUTING_en.md`, per §9.1's recommendation
to document rather than unify.
