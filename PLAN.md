...
**Revision:** 40 (2026-09-22) — P2-5 complete: the `LoggerPlugin` pin is gone and the
per-command loggers it had silently dropped are restored. An earlier "no behaviour
change" claim for P2-1a was wrong on this point and is corrected.
`logger.ts`.
