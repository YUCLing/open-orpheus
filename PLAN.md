...
**Revision:** 38 (2026-09-22) — P2-5 step 2: `window.ts` → `windows/managedWindow.ts`,
so the `windows/` group owns both the `BrowserWindow` definitions and the
`ManagedWindow` model it documents.
