...
**Revision:** 47 (2026-09-22) — P3-4: `verbatimModuleSyntax` turns out to be **blocked**, not
cheap. 47 of its 52 sites are mechanical type-only imports, but the other 5 are ambient
const enums from the native modules' `.d.ts`, which §1.3 puts out of scope.
...
| P3-4  | Mid-cost strictness flags (130 errors total)                                                   | P3    | **In progress** | 2026-09-22 | **`noPropertyAccessFromIndexSignature` enabled** (35 sites, all TS4111, applied by driving `tsc`'s own suggestions). **`verbatimModuleSyntax` is blocked, not pending** — 47 mechanical sites plus 5 ambient const enums the compiler cannot inline, so it cannot be enabled without changing the native modules' declarations. **Remaining:** `exactOptionalPropertyTypes` (51). Re-measure before trusting §4.2's numbers: they had drifted 130 → 138.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
