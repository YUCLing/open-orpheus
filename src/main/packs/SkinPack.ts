...
// 2048-bit RSA PUBLICKEYBLOB from cloudmusic_64.dll (CryptImportKey arg in FUN_180d275e0)
...
function verifySignature(sig: Buffer, data: Buffer): boolean {
  // WinCrypt stores RSA signatures little-endian → reverse to PKCS#1 big-endian
